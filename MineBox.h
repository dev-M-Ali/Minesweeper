...
public:
	...
	MineBox(int i, int j, int value) :Box(i, j, value)
	{
		state = 0;
	}
	...
	void Draw(int xPixelConstant, int yPixelConstant)
	{
		...
		{
			myBoxRect(xPixelConstant + (j * 42), yPixelConstant + (i * 42), xPixelConstant + 40 + (j * 42), yPixelConstant + 40 + (i * 42), 255, 0, 0);
			myEllipse(xPixelConstant + (j * 42) + 10, yPixelConstant + (i * 42) + 10, xPixelConstant + 40 + (j * 42) - 10, yPixelConstant + 40 + (i * 42) - 10, 150, 150, 150);
		}
		else if (state == 2)
		{
			myBoxRect(xPixelConstant + (j * 42), yPixelConstant + (i * 42), xPixelConstant + 40 + (j * 42), yPixelConstant + 40 + (i * 42), 211, 211, 211);
