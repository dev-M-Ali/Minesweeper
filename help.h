...
//Updated functions
void myBoxRect(int x1, int y1, int x2, int y2, int R, int G, int B) //myRect with grey boundaries
{
	HWND console_handle = GetConsoleWindow();
	HDC device_context = GetDC(console_handle);
...
void myThickRect(int x1, int y1, int x2, int y2, int R, int G, int B)
{
	HWND console_handle = GetConsoleWindow();
	HDC device_context = GetDC(console_handle);
...
void myThickLine(int x1, int y1, int x2, int y2, int R, int G, int B) //use three 3 integers if you want colored lines.
{
	HWND console_handle = GetConsoleWindow();
	HDC device_context = GetDC(console_handle);
